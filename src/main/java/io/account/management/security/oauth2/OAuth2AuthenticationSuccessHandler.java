...
/**
 * - 인증에 성공하면 Spring Security 가 SecurityConfig에서 구성된 OAuth2AuthenticationSuccessHandler 의 메서드 onAuthentication 을 호출한다.
 * - validations, jwt 토큰 생성, 유저 redirect 등 의 처리를 한다.
 */
